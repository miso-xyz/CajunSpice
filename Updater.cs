...
namespace CajunSpice
{
    class Updater
    {
        public Updater(byte[] updateFileStream)
        {
            ...
            UpdateDownloadName = "CajunSpice-Update_v" + LatestVersion + ".zip";
        ...
        public const string
            CurrentAppName = "CajunSpice",
            CurrentVersion = "1.0",
            RepoLink = "https://github.com/miso-xyz/CajunSpice",
            UpdateLogLink = "https://raw.githubusercontent.com/miso-xyz/CajunSpice/main/latest.info";
        ...
        void wc_DownloadFileCompleted(object sender, System.ComponentModel.AsyncCompletedEventArgs e)
        {
            ...
            p.StartInfo.Arguments = "/K timeout /T 1 /nobreak && cd " + AppDomain.CurrentDomain.BaseDirectory + " && 7z.exe e -y " + UpdateDownloadName + " && start CajunSpice.exe " + '"' + Program.path + '"' + " && exit";
